...
import edu.up.cs.androidcatan.gameframework.config.GameConfig;
import edu.up.cs.androidcatan.gameframework.config.GamePlayerType;
import edu.up.cs.androidcatan.gameframework.util.IPCoder;
