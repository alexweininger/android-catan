...
public class HexagonGrid extends BoardSurfaceView {
    ...
    public void generateIntersections(){
        ...
        intersections[31] = new Intersection(0, 1049, 642);
        intersections[32] = new Intersection(0, 1049, 642);
        intersections[33] = new Intersection(0, 1049, 642);
        intersections[34] = new Intersection(0, 1049, 642);
        intersections[35] = new Intersection(0, 1049, 642);
        intersections[36] = new Intersection(0, 1049, 642);
        intersections[37] = new Intersection(0, 1049, 642);
        intersections[38] = new Intersection(38, 1049, 642);
        intersections[39] = new Intersection(39, 1049, 642);
        intersections[40] = new Intersection(, 1049, 642);
        intersections[41] = new Intersection(, 1049, 642);
        intersections[42] = new Intersection(, 1049, 642);
        intersections[43] = new Intersection(, 1049, 642);
        intersections[44] = new Intersection(, 1049, 642);
        intersections[45] = new Intersection(, 1049, 642);
        intersections[46] = new Intersection(, 1049, 642);
        intersections[47] = new Intersection(, 1049, 642);
        intersections[48] = new Intersection(, 1049, 642);
        intersections[49] = new Intersection(, 1049, 642);
        intersections[50] = new Intersection(, 1049, 642);
        intersections[51] = new Intersection(, 1049, 642);
        intersections[52] = new Intersection(, 1049, 642);
        intersections[53] = new Intersection(, 1049, 642);
        intersections[54] = new Intersection(, 1049, 642);
    }
